...
def printinfo(Genre,temp):
    ...
    if (Genre == 1):
        ...
        files = ["Austria_dataset/" + file for file in files]
        print(files[0])
        seed_input  = open(files[np.random.randint(low = 0, high= len(files))]).read()

    elif (Genre == 2):
        model,MAPPING_PATH = "models/czech_model.h5","mappers/czech_mapping.json"
        files = os.listdir("czech_dataset/")
...
#     seed = "55 _ _ _ 60 _ _ _ _ _ 62 _ 64 _ _ _ 62 _ _ _ 62 _ _ _ 55 _ _ _ 57 _ _ _ 59 _ _ _ 57 _ _ _ 55 _ _ _ _ _ _ _ 55 _ _ _ 60 _ _ _ 62 _ _ _ 64 _ _ _ 62 _ _ _ 62 _ _ _ 67 _ _ _ 66 _ _ _ _ _ 67 _ 69"
    seed = seed_input
